...
async def test_full_flow():
    ...
    print("Test 1: Low-value, low-risk transaction")
    ...
    print("Test 2: High-value transaction requiring full processing")
    ...
    print("Test 3: Transaction with sanctioned entity")
    ...
    print("Test 4: Transaction with missing postal code")
